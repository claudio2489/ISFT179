	...
	<div class="container">
		<div class="row blog-row">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 margin_bottom30">
				<a href="#">
					<img class="img-responsive center-block" src="img/13.jpg" width=100% height="250">
				</a>
				<div class="blog-content bg-white">
					<h3>Titulo de la noticia</h3>
					<p>Esto es un texto relacionado a la noticia que se quiere publicar junto con la imagen. Podemos emplear un comentario de hasta 500 caracteres al igual que la publicacion se puede compartir en las redes Sociales.<a href="javascript::;"  class="heading_color">  Continuar leyendo..</a></p>
					<p><span>Compartir: : 
					...
					<span class="pull-right">Subido por : <strong> "Administrador"</strong></span> </p>
				</div>
				<hr>
			</div>
			<div class="col-md-12 col-sm-12 col-xs-12 margin_bottom30">
				<a href="#">
				<img class="img-responsive center-block" src="img/13.jpg" height="250">
				</a>
				<div class="blog-content bg-white">
					<h3>Titulo de la noticia</h3>
					<p>Esto es un texto relacionado a la noticia que se quiere publicar junto con la imagen. Podemos emplear un comentario de hasta 500 caracteres al igual que la publicacion se puede compartir en las redes Sociales.<a href="javascript::;"  class="heading_color">  Continuar leyendo..</a></p>
